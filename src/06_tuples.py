...
def print_tuple(arg1: tuple):
    """Takes a tuple and prints each value to stdout.

    Args:
        arg1 (tuple): A tuple of any length that contains values.

    Yields:
        Each value contained in arg1 to stdout.
    """
    try:
        for value in arg1:
            print(value)
